...
for id = 1:length(torun)
    load(d2(torun(id)).name,'other_cells','spikedata','vel','pos','dirdat','linposcat','armpos','laps_singlepass','behave_change_log')
...
tit = ['10-fold crossval, all PFC neruons (N = ' num2str(size(Rall,1)) ')'];
title(tit)
xlabel('Time Window/Bin (Seconds)')
ylabel('R-squared')
set(gca,'FontSize',18)
set(gcf,'Position',[    2006          68         906         696])
helper_saveandclosefig([figlab '\CompLinearModels_' num2str(num_folds) 'fold_Neurons_N' num2str(size(Rall,1)) ])
...
set(gca,'FontSize',18)
set(gcf,'Position',[    2006          68         906         696])
helper_saveandclosefig([figlab '\CompLinearModels_' num2str(num_folds) 'fold_Dayd_N' num2str(size(Rallid,1)) ])
...
%     end    
 ...
 legend(a,{'Arm';'Corr/Incorr';'Direction';'Speed';'Distance from center';'Distance to heading reward';'Distance traveled';'Time to Reward';'Time since left'},'Location','Best')
set(gca,'xtick',1:length(bn),'xticklabel',bn)
tit = ['10-fold crossval, GLM all PFC neruons (N = ' num2str(size(Rall,1)) ')'];
title(tit)
xlabel('Time Window/Bin (Seconds)')
ylabel('R-squared')
set(gca,'FontSize',18)
set(gcf,'Position',[    2006          68         906         696])
helper_saveandclosefig([figlab '\CompLinearModels_GLM_' num2str(num_folds) 'fold_Neurons_N' num2str(size(Rpopall2,1)) ])
...
helper_saveandclosefig([figlab '\CompLinearModels_GLM_fewer_' num2str(num_folds) 'fold_Neurons_N' num2str(size(Rpopall2,1)) ])
