...
%         OutFR(i,index(:,iarm))=FRnew4(21:end-20);
        ...
        t=find(Spike(:,4)>VelThresh & Spike(:,1)==Cell_Number(i) & Spike(:,5)==0 & Spike(:,6)==iarm);
        if length(t)~=1
...
if ~isfolder('E:\XY_matdata\Figures\ForPaper\Basics\')
    mkdir('E:\XY_matdata\Figures\ForPaper\Basics\')
end
helper_saveandclosefig(['E:\XY_matdata\Figures\ForPaper\Basics\Linear_PFs_' thisdir(1:end-4)])