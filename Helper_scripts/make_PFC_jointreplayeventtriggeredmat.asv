function [PFCreplayspikes_list,PFCreplayspikes_binned] = make_PFC_jointreplayeventtriggeredmat(thisdir,label,timetrig,tosave)

load(thisdir,[label '_replay_stnd'],'other_cells','spikedata',[label '_replay_singlebothjoint'],[label  '_replay_jointjumptime'])
...
elseif timetrig == 2
    eval(['Event = ' label  '_replay_jointjumptime;'])
end


clear([label '_replay_stnd'])
clear([label '_jointjumptime'])
