function make_PFC_thetaeventtriggeredmat(thisdir)
disp('Start make_PFC_thetaeventtriggeredmat')
...
save(thisdir,'PFCthetaspikes_binned','PFCthetaspikes_list','-append')

disp('Done with make_PFC_thetaeventtriggeredmat')
