function[RallV,RallT,RallS,RallP,RallTrev,RallA,RallProp,pT,pV,pTrev]  = Velocity_Vs_Value(thisdir,binsize,label,savefolder)
% [RsV2,RsT2,RsS2,RsP2,RsTrev2,coeff,armsig,R1,R2,coeff1,coeff2]

%  [RallV,RallT,RallS,RallP,RallTrev,RallA,RallProp,pT,pV,pTrev] 
% [RsV2,RsT2,RsS2,RsP2]
load(thisdir,'other_cells','spikedata','vel','behave_change_log','laps_singlepass','pos','linposcat','armpos',...
...
%     helper_saveandclosefig(['D:\XY_matdata\Figures\ForPaper\CompLinearModels\' dirname '_Cell' num2str(other_cells(icell))])
    helper_saveandclosefig([savefolder '\CompLinearModels\' dirname '_Cell' num2str(other_cells(icell))])
end
