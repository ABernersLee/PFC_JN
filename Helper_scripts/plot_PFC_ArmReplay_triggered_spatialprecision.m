...
%         end
    ...
    axis tight
    title(num2str(pfc(icell)))
    helper_saveandclosefig(['E:\XY_matdata\Figures\ForPaper\ArmReplayTriggered\' label '_' thisdir(1:end-4) '_Precision_Binned3_Cell' num2str(pfc(icell))])
end
