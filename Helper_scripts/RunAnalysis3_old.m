...
%     - Internal Fields        %,toplot,toplotcells,tosave)   
    if igroup~=2
        Figure3_Internal2d(dirs,igroup,savefolder,false,false,.04,5,4,5,1000,.5); % or 1 % clean up,
        Figure3_Internal2d(dirs,igroup,savefolder,false,false,.04,5,4,5,1000,1.5); 
        Figure3_Internal2d(dirs,igroup,savefolder,false,false,.04,5,4,5,1000,2.5); 
